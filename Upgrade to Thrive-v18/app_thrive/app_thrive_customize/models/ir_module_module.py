...
class IrModule(models.Model):
    ...
    def module_multi_refresh_po(self):
        ...
        # 先清理, thrive原生经常清理不干净
        # thrivebureau 16中，不再使用 ir.translation，直接使用json字段
        # for rec in modules:
    ...
    def button_get_po(self):
        self.ensure_one()
        action = self.env.ref('app_thrive_customize.action_server_module_multi_get_po').sudo().read()[0]
