...
from thrive import http, tools, modules, _
from thrive.http import Controller, request, route


class DocumentationController(http.Controller):

    @http.route('/documentation/17.0', type='http', auth='public', methods=['GET'])
    def documentation(self):
        return request.redirect('app_thrive_doc/static/documentation/17.0/index.html')
    ...
    def redirect_to_doc(self, file_name, version='16.0'):
        ...
        module_path = modules.get_module_path('app_thrive_doc', display_warning=False)
        ...
        #     todo: 当前直接303转资源
        return request.redirect('/app_thrive_doc/static%s' % base_url_doc, 303)
