...
from thrive import fields, models, tools, _
...
class BackendConfig(models.Model):
	...
	def _default_app_drawer_bg_image(self):
		image_path = get_resource_path(
			'spiffy_theme_backend_ent', 'static/description', 'app-drawer-bg-image.png')
		with tools.file_open(image_path, 'rb') as f:
			return base64.b64encode(f.read())
	
	def _default_menu_bg_image(self):
		image_path = get_resource_path(
			'spiffy_theme_backend_ent', 'static/description', 'header_vertical_mini.svg')
		with tools.file_open(image_path, 'rb') as f:
			return base64.b64encode(f.read())
